...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // Team Mode
    'team.mode': '团队模式',
    'team.toggle': '团队模式：Opus 编排 + Grok 搜索调研',
    'team.searching': '搜索中',
    'team.round': '轮次',
    'team.sources': '来源',
    'team.noSources': '开启团队模式后，搜索来源将显示在此处',
    'team.viewAll': '查看所有来源',
    'team.maxRounds': '最大搜索轮次',
    'team.searchingWith': '正在通过 Grok 搜索...',
    'team.searchingWith.gemini': '正在通过 Gemini 搜索...',
    'team.backend.grok': 'Grok 搜索',
    'team.backend.gemini': 'Gemini 搜索',
    'team.geminiApiKey': 'Gemini API Key',
    'team.geminiModel': 'Gemini 模型',
    'team.geminiApiKeyRequired': '需要 Gemini API Key',
    'team.searchBackend': '搜索后端',
    ...
    // IM Channels
    'im.telegram.botToken': 'Bot Token',
    'im.telegram.botTokenHint': '通过 Telegram @BotFather 创建 Bot 并获取 Token',
    'im.telegram.allowedChats': '白名单 Chat ID（可选）',
    'im.telegram.allowedChatsHint': '限制 Bot 响应的 Chat ID，多个用逗号分隔。留空则响应所有消息',
    'im.connect': '连接',
    'im.disconnect': '断开',
    'im.connecting': '连接中...',
    'im.connected': '已连接',
    ...
    'im.sessionMode': '会话模式',
    'im.perChat': '独立会话',
    'im.perChatDesc': '每个 IM 聊天使用独立的 Claude CLI 会话，上下文互相隔离',
    'im.shared': '共享会话',
    'im.sharedDesc': '所有 IM 聊天共享同一个 Claude CLI 会话和上下文',
    'im.moreChannels': '更多通道',
    'im.comingSoon': '即将推出',
  },
  ...
  en: {
    ...
    // Team Mode
    'team.mode': 'Team Mode',
    'team.toggle': 'Team Mode: Opus orchestration + Grok web research',
    'team.searching': 'Searching',
    'team.round': 'Round',
    'team.sources': 'Sources',
    'team.noSources': 'Enable Team Mode to see search sources here',
    'team.viewAll': 'View all sources',
    'team.maxRounds': 'Max search rounds',
    'team.searchingWith': 'Searching with Grok...',
    'team.searchingWith.gemini': 'Searching with Gemini...',
    'team.backend.grok': 'Grok Search',
    'team.backend.gemini': 'Gemini Search',
    'team.geminiApiKey': 'Gemini API Key',
    'team.geminiModel': 'Gemini Model',
    'team.geminiApiKeyRequired': 'Gemini API Key required',
    'team.searchBackend': 'Search Backend',
    ...
    // IM Channels
    'im.telegram.botToken': 'Bot Token',
    'im.telegram.botTokenHint': 'Create a bot via Telegram @BotFather and get the token',
    'im.telegram.allowedChats': 'Allowed Chat IDs (optional)',
    'im.telegram.allowedChatsHint': 'Restrict bot to specific Chat IDs, comma-separated. Leave empty to respond to all',
    'im.connect': 'Connect',
    'im.disconnect': 'Disconnect',
    'im.connecting': 'Connecting...',
    'im.connected': 'Connected',
    'im.error': 'Connection failed',
    'im.sessionMode': 'Session Mode',
    'im.perChat': 'Per Chat',
    'im.perChatDesc': 'Each IM chat uses an independent Claude CLI session with isolated context',
    'im.shared': 'Shared',
    'im.sharedDesc': 'All IM chats share a single Claude CLI session and context',
    'im.moreChannels': 'More Channels',
    'im.comingSoon': 'Coming Soon',
  },
};
